...
<body>
    ...
    <div class="form-group">
        ...
        <input type="text" name="nama_lengkap" class="form-control form-control-sm"
            id="exampleInputNama" placeholder="Nama Lengkap" value="{{ old('nama_lengkap') }}" required>
    ...
    <div class="d-grid">
        <button type="submit" class="btn btn-primary rounded btn-lg mt-4 fs-6">{{ __('Registrasi') }}</button>
    </div>
</form>
