<aside class="sidebar" id="panel-sidebar">
    ...
    <div class="sidebar-menu-content">
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item devider {{ Request::segment(2) == 'laporanperkembangan' ? 'active' : '' }}">
                <a href="{{ route('laporanperkembangan.index') }}" class="item-link">
    ...
    <li class="sidebar-menu-item devider {{ Request::segment(2) == 'profile' ? 'active' : '' }}">
        <a href="{{ route('profile-admin.index') }}" class="item-link">
            <i class="fa fa-user link-icon"></i>
            <span>Profile</span>
        </a>
    </li>
