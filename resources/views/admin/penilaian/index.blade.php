...
<div class="container mt-4">
    <div class="bg-white rounded-4 px-3 py-4 mb-3 shadow-lg">
        ...
        <div class="d-flex flex-row mx-2">
            <div class="me-2 w-100 mx-1">
               <select class="w-100 btn btn-secondary py-2 w-100 rounded-3">
                    <option><a class="option" href="#">Pilih Event</a></option>
                    <option><a class="option" href="#">Event 1</a></option>
                    <option><a class="option" href="#">Event 2</a></option>
                    <option><a class="option" href="#">Event 3</a></option>
                </select>
            </div>
            <div class="me-2 w-100 mx-1">
               <select class="w-100 btn btn-secondary py-2 w-100 rounded-3">
                    <option><a class="option" href="#">Pilih Skema</a></option>
                    <option><a class="option" href="#">Skema 1</a></option>
                    <option><a class="option" href="#">Skema 2</a></option>
                    <option><a class="option" href="#">Skema 3</a></option>
                </select>
            </div>
