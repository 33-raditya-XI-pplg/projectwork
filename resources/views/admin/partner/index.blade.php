                ...
                <form action="{{ route('partner.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="dropzone-wrapper">
                            ...
                            <input type="file" name="logo" class="dropzone"  accept="image/*" style=" width: 100%; height: 240px;" required>
                            <div id="image_preview_" class="mt-3">
                                <img id="preview_image_create" src="" alt="Image preview" style="display: none;  max-height:200px; max-width:200px;">
                            </div>
                        </div>
                        <div class="mt-2">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="dropzone-wrapper">
                                        ...
                                        <input type="file" name="logo" class="dropzone" id="logo_{{ $partner->id_partner }}" accept="image/*" style=" width: 100%; height: 240px;">
                                        <div id="image_preview_{{ $partner->id_partner }}" class="mt-3 d-flex justify-content-center max-height:200px; max-width:200px;">
                                            @if($partner->logo)
