                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <form action="{{ route('instansi.store') }}" method="POST">
                                    ...
                                    <div class="d-grid">
                                        <button class="btn btn-primary rounded-3 text-start" type="button">Upload Logo <i class="fa-solid fa-upload"></i></button>
                                    </div>
                            </div>
                            <div class="col">
                                {{-- kiri --}}
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="nama_kepala_instansi" id="nama_kepala_instansi" required>
                                </div>
                                <div class="mb-3">
                                    <label for="jabatan_kepala" class="form-label">Jabatan</label>
                                    <input type="text" class="form-control" name="jabatan_kepala" id="jabatan_kepala" required>
                                </div>
