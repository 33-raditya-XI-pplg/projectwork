...
class DashboardController extends Controller
{
    public function user_index()
    {
        ...
        $isProfileComplete = !empty($user->nama_lengkap) && !empty($user->alamat) && !empty($user->jenis_kelamin)
            ...
            && !empty($user->tahun_lulus)
            // && !empty($user->nama_perusahaan) && !empty($user->alamat_perusahaan)
    ...
    public function penguji_index()
    {
        ...
        $isProfileComplete = !empty($user->nama_lengkap) && !empty($user->alamat) && !empty($user->jenis_kelamin)
            ...
            // && !empty($user->nama_sekolah) && !empty($user->jurusan) && !empty($user->jenjang) && !empty($user->tahun_lulus)
            // && !empty($user->nama_perusahaan) && !empty($user->alamat_perusahaan)
            // && !empty($user->alamat_kota_perusahaan) && !empty($user->jabatan_pekerjaan) && !empty($user->no_telp_perusahaan)
        ;
