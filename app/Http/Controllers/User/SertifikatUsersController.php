...
class SertifikatUsersController extends Controller
{
    ...
    // Method baru untuk menampilkan sertifikat berdasarkan peserta_id
    public function showSertifikat($peserta_id)
    {
        // Ambil event_skema_id dari peserta_id
        ...
        // Gunakan method cetak yang sudah ada
        return $this->cetak($peserta->event_skema_id);
    }
    ...
    public function show($eventID)
    {
        ...
        $data_skema = DB::table('tb_peserta')
            ...
            ->select(
                ...
                'tb_skema.nama_skema',
                'tb_peserta.id_peserta', // Tambahkan ini
