    ...
    public function index(Request $request)
{
    try {
        ...
        if (!empty($page_nama)) {
            $data = $data->join('tb_page', 'tb_profil_perusahaan.page_id', '=', 'tb_page.id_page')
                         ->where('tb_page.nama_page', $page_nama)
                         ->select('tb_profil_perusahaan.*'); // Pilih kolom dari tabel Blog
        }
