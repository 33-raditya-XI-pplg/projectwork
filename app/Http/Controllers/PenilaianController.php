...
class PenilaianController extends Controller
{
    ...
    public function fetchSkemaData($id, $event_id)
    {
        ...
        $data_nilai_peserta = DB::table('tb_peserta')
            ...
            ->leftJoinSub(function ($query) use ($eventSkemaId) {
                $query->from('tb_rentang_nilai')
                    ...
                    ->select(
                        ...
                        'tb_event_skema_rentang_nilai.rentang_nilai_id',
            ...
            ->select(
                ...
                'nilai_stats.banyak_nilai_nol',
                'nilai_stats.total_nilai',
                'nilai_stats.avg_nilai',
                'inisial_nilai.keterangan_rentang_nilai',
                'inisial_nilai.inisial_rentang_nilai',
                'inisial_nilai.nama_konversi_nilai',
                'nilai_timestamp.created_at',
                'nilai_timestamp.updated_at'
            )
    ...
    public function fetchNilaiData($id)
    {
        $data_nilai = DB::table('tb_nilai_peserta')
            ...
            ->select(
                'tb_nilai_peserta.event_skema_id',
                'tb_nilai_peserta.sub_skema_id',
                'tb_sub_skema.judul_sub',
                'tb_nilai_peserta.peserta_id',
                'tb_user.nama_lengkap',
